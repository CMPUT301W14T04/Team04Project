...
/**
 * 
 * This class take all the necesary data to create a author. It also create a ID
 * for the user so that multiples author can have same username, yet still be
 * unique in the system. if username it is not define by the user, he/she
 * username will be Anonymous.
 * 
